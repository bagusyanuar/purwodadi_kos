...
@section('content')
    <div class="d-flex align-items-center justify-content-between mb-3">
        <p class="font-weight-bold mb-0" style="font-size: 20px">Halaman Peraturan</p>
        <ol class="breadcrumb breadcrumb-transparent mb-0">
            <li class="breadcrumb-item">
                <a href="{{ route('dashboard') }}">Dashboard</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Peraturan
            </li>
        </ol>
    </div>
    <div class="w-100 p-2">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddLabel">Tambah Peraturan</h5>
...
@section('js')
    ...
    <script>
        ...
        function patch() {
            let id = $('#id').val();
            let url = '{{ route('admin.peraturan') }}' + '/' + id;
            let data = {
                nama: $('#nama-edit').val(),
            };
            AjaxPost(url, data, function () {
        ...
        function destroy(id) {
            let url = '{{ route('admin.peraturan') }}' + '/' + id + '/delete';
